...
func (c *leadServiceClient) PutLead(ctx context.Context, in *PutLeadRequest, opts ...grpc.CallOption) (*PutLeadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PutLeadResponse)
	err := c.cc.Invoke(ctx, LeadService_PutLead_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LeadService_PutLead_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PutLeadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LeadServiceServer).PutLead(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LeadService_PutLead_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LeadServiceServer).PutLead(ctx, req.(*PutLeadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LeadService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "lead-service/grpc/lead-grpc/lead.proto",
}
