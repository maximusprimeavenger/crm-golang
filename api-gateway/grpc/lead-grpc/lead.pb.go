...
func (x *PatchLeadRequest) Reset() {
	*x = PatchLeadRequest{}
	mi := &file_api_gateway_grpc_lead_grpc_lead_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PatchLeadRequest) Descriptor() ([]byte, []int) {
	return file_api_gateway_grpc_lead_grpc_lead_proto_rawDescGZIP(), []int{10}
}
...
func (x *PatchLeadResponse) Reset() {
	*x = PatchLeadResponse{}
	mi := &file_api_gateway_grpc_lead_grpc_lead_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PatchLeadResponse) Descriptor() ([]byte, []int) {
	return file_api_gateway_grpc_lead_grpc_lead_proto_rawDescGZIP(), []int{11}
}
...
var file_api_gateway_grpc_lead_grpc_lead_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
